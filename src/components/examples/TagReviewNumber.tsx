    ...
    <div className="p-4">
      <div className="mx-auto flex w-fit flex-col items-start gap-10">
        ...
        <div className="w-full">
          <TagReviewNumber iconType="음향" title="음향에 대한 태그 내용" count={132} />
        </div>

        {/* 2. 관람 환경 태그 */}
        <div className="w-full">
          <TagReviewNumber iconType="관람환경" title="관람 환경에 대한 태그 내용" count={98} />
        </div>

        {/* 3. 동반인 태그 */}
        <div className="w-full">
          <TagReviewNumber iconType="동반인" title="동반인에 대한 태그 내용" count={204} />
        </div>
      </div>
    </div>
  );
